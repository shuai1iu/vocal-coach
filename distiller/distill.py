"""
Distill Google Gemini chat history into a structured zen-master journal.
...
def distill(transcript: str) -> str:
    ...
    user_msg = (
        ...
        f"<gemini_history>\n{transcript}\n</gemini_history>\n\n"
        f"按 prompt 中规定的 schema 蒸馏成禅师档案，输出只包含 markdown 档案本身。"
    )
...
def main():
    p = argparse.ArgumentParser(description="Distill Gemini chat history into a zen-master journal")
